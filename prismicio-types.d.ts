...
type HomepageDocumentDataSlicesSlice = HeroSlice | ProductGridSlice | TextAndImageSlice | VideoBlockSlice | TeamGridSlice
...
interface HomepageDocumentData {
	 ...
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: Suburbia Skateboard
...
interface SkateboardDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	customizer: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
}
...
export type AllDocumentTypes = BoardCustomizerDocument | HomepageDocument | SettingsDocument | SkateboardDocument | SkaterDocument;
...
export interface ProductGridSliceDefaultPrimaryProductItem {
	 ...
	 */
	skateboard: ContentRelationshipFieldWithData<[{"id":"skateboard","fields":["name","image","price","customizer"]}]>;
}
